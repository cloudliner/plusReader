...
-(void)testCLHexStringToUInt {
  ...
  // TODO: 実機で単体テストを実行するための暫定対策
	// unsigned int result = CLRIntForHexString(@"FF00FF00");
  unsigned int result = [CLRUtils CLRIntForHexString:@"FF00FF00"];
...
-(void)testCLUIntToHexString {
  ...
  // TODO: 実機で単体テストを実行するための暫定対策
  // NSString *result = CLRHexStringForInt(0xFFAAFFAA);
  NSString *result = [CLRUtils CLRHexStringForInt:0xFFAAFFAA];
